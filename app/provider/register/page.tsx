...
export default function ProviderRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Registration successful! Welcome to QuickWorkNG!")
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-2">Join QuickWorkNG</h1>
            <p className="text-muted-foreground">Start connecting with customers and grow your business today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Portfolio (Optional but Recommended)</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Upload photos of your past work to showcase your skills. You can upload up to 6 images.
                </p>

                <ImageUpload images={portfolioImages} onImagesChange={handleImagesChange} maxImages={6} maxSizeMB={5} />
              </CardContent>
            </Card>

...
import { Star, Phone, Mail, MapPin, Edit, Upload, Eye, MessageSquare, TrendingUp } from "lucide-react"
...
const recentReviews = [
  {
    ...
    rating: 5,
    comment: "Absolutely amazing work! Transformed our living room beautifully.",
    date: "2 days ago",
  },
  {
    id: 2,
  ...
  const handlePortfolioUpdate = async (images: File[]) => {
    ...
    try {
      ...
      const updatedUserData = {
        ...userData,
        portfolioImages: [...(userData.portfolioImages || []), ...processedImages],
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <Link href={`/provider/${providerData.name.toLowerCase().replace(/\s+/g, "-")}`}>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">Welcome back, {providerData.name}!</h1>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{providerData.profileViews}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">{providerData.contactRequests}</p>
                    </div>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center mt-2 text-sm">
                    <span className="text-muted-foreground">Based on {providerData.totalReviews} reviews</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Portfolio Images</p>
                      <p className="text-2xl font-bold">{providerData.portfolioImages}</p>
                    </div>
                    <Upload className="h-8 w-8 text-blue-600" />
                  </div>
                  <div className="flex items-center mt-2 text-sm">
                    <span className="text-muted-foreground">Showcase your work</span>
                  </div>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {recentInquiries.slice(0, 3).map((inquiry) => (
                      <div key={inquiry.id} className="flex items-start gap-3 p-3 border rounded-lg">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-muted-foreground mb-1">{inquiry.service}</p>
                    ...
                    <div key={inquiry.id} className="flex items-start gap-4 p-4 border rounded-lg">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm text-muted-foreground ml-auto">{inquiry.date}</span>
                        </div>
                        <p className="text-sm font-medium mb-2">Service: {inquiry.service}</p>

...
export default function LoginPage() {
  ...
  const [userType, setUserType] = useState<"customer" | "provider">(searchParams.get("type") === "provider" ? "provider" : "customer")
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Access your account and get started</p>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link 
                    href={userType === "customer" ? "/customer/forgot-password" : "/provider/forgot-password"} 

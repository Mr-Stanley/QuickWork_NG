...
import { Calendar, Clock, CheckCircle, MessageSquare, User, LogOut, Plus, Gift, Coins, X } from "lucide-react"
...
const sampleServiceHistory = [
  {
    ...
    providerName: "Squegy Cleaning Services",
    date: "2023-10-15",
    status: "completed",
    rating: 5,
    pointsEarned: 1200,
  ...
  },
  {
    ...
    providerName: "PowerPro Electricals",
    date: "2023-11-05",
    status: "scheduled",
    rating: null,
    pointsEarned: 0,
...
export default function CustomerDashboard() {
  ...
  const totalPoints = serviceHistory.reduce((sum, service) => sum + (service.pointsEarned || 0), 0)
  ...
  const confirmRedemption = () => {
    ...
    alert('Congratulations! ₦1,000 airtime will be sent to your registered phone number.')
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Manage your service requests and view your service history</p>
            </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Upcoming Services</p>
                      <p className="text-2xl font-bold">
                        {serviceHistory.filter((service) => service.status === "scheduled").length}
                      </p>
                    </div>
              ...
              <Card className={canRedeemPoints ? "border-green-200 bg-green-50" : ""}>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Progress value={(totalPoints / 5000) * 100} className="h-2" />
                    
                    <Button 
                      onClick={handleRedeemPoints} 
                      variant={canRedeemPoints ? "default" : "outline"}
                      className={canRedeemPoints ? "w-full mt-2 bg-green-600 hover:bg-green-700" : "w-full mt-2"}
            ...
            <Card>
              ...
              <CardContent>
                    ...
                    <div key={service.id} className="flex items-start gap-3 p-3 border rounded-lg">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge
                            variant={service.status === "completed" ? "secondary" : "default"}
                        ...
                        <p className="text-sm text-muted-foreground mb-1">Provider: {service.providerName}</p>
                ...
                <Button variant="outline" className="w-full mt-4" onClick={() => setActiveTab("services")}>
                  View All Services
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-blue-50 border-blue-100">
              <CardContent className="p-6">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  <div>
                    <h3 className="text-lg font-semibold text-blue-800 mb-2">Need a service professional?</h3>
                    <p className="text-blue-700">Fill out our service request form and get quotes from verified providers.</p>
                  </div>
                  <Link href="/customer/request-service">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <p className="text-sm text-muted-foreground">
              Airtime will be sent to your registered phone number: <span className="font-medium">{userData.phone}</span>
            </p>
          </div>
          <DialogFooter className="flex space-x-2 sm:space-x-0">
            ...
            <Button type="button" onClick={confirmRedemption} className="bg-green-600 hover:bg-green-700">
              Confirm Redemption
            </Button>
          </DialogFooter>
        </DialogContent>
